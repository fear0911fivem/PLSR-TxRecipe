...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
	exports["pulsar-core"]:RegisterServerCallback("Phone:Message:InitLoad", function(source, data, cb)
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Messages:LoadTexts", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local messages = MySQL.rawExecute.await(
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Messages:SendMessage", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		local data2 = {
			owner = data.number,
			number = data.owner,
		...
		if id then
			local targetChar = exports['pulsar-characters']:FetchCharacterData("Phone", data.number)
			if targetChar ~= nil then
				data2.id = id.insertId + 1
				data2.contact = exports['pulsar-phone']:ContactsIsContact(targetChar:GetData("SID"), data2.number)
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Messages:ReadConvo", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			exports['pulsar-phone']:MessagesRead(char:GetData("Phone"), data)
		end
	end)

	exports["pulsar-core"]:RegisterServerCallback("Phone:Messages:DeleteConvo", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			exports['pulsar-phone']:MessagesDelete(char:GetData("Phone"), data)
			cb(true)
		else
			cb(false)
		end
