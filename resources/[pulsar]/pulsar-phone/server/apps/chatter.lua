...
AddEventHandler("Phone:Server:RegisterMiddleware", function()
	...
	exports['pulsar-core']:MiddlewareAdd("Characters:Spawning", function(source)
		local sid = exports['pulsar-characters']:FetchCharacterSource(source):GetData("SID")
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:GetMessageCount", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:LoadMessages", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			if _groups[sid] ~= nil then
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:SendMessage", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			if _groups[sid] ~= nil then
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:CreateGroup", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			local ts = os.time()
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:LeaveGroup", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
	...
	exports["pulsar-core"]:RegisterServerCallback("Phone:Chatter:DeleteGroup", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
	...
	exports["pulsar-core"]:RegisterServerCallback("Chatter:Invite:Send", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			...
			if tonumber(data.sid) ~= sid then
				if _groups[sid] then
					...
					if inGroup then
						local tChar = exports['pulsar-characters']:FetchBySID(tonumber(data.sid))
						if tChar ~= nil then
	...
	exports["pulsar-core"]:RegisterServerCallback("Chatter:Invite:Accept", function(source, data, cb)
	...
	exports["pulsar-core"]:RegisterServerCallback("Chatter:Invite:Decline", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			_invites[sid] = _invites[sid] or {}
	...
	exports["pulsar-core"]:RegisterServerCallback("Chatter:UpdateGroup", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
