...
AddEventHandler('onClientResourceStart', function(resource)
	if resource == GetCurrentResourceName() then
		Wait(1000)
		exports["pulsar-kbs"]:Add("radar_lock", "MULTIPLY", "keyboard", "Radar - Toggle Fast Lock", function()
		...
		exports["pulsar-kbs"]:Add("radar_remote", "DIVIDE", "keyboard", "Radar - Open Menu/Remote", function()
			OpenRadarRemote()
		end)

		exports["pulsar-kbs"]:Add("radar_toggle", "SUBTRACT", "keyboard", "Radar - Show/Hide", function()
			ToggleRadarIsDisabled()
		end)

		exports["pulsar-kbs"]:Add("heli_toggle", "E", "keyboard", "Heli Camera - Toggle", function()
			StartHeliCamera()
		end)

		exports["pulsar-kbs"]:Add("heli_rappell", "X", "keyboard", "Heli - Rappel", function()
			HeliRappel()
		end)

		-- exports["pulsar-kbs"]:Add("heli_lock", "SPACE", "keyboard", "Heli Camera - Lock On/Off", function()
		-- 	LockOnHeliCamera()
		-- end)

		-- exports["pulsar-kbs"]:Add("heli_camera", "MOUSE_RIGHT", "MOUSE_BUTTON", "Heli Camera - Change Mode", function()
		-- 	ChangeVision()
		-- end)
	end
end)
		...
		CreateThread(function()
			while RADAR_ENABLED do
				...
				if RADAR_SETTINGS.frontRadar.transmit or RADAR_SETTINGS.rearRadar.transmit then
					...
					local vehHeading = exports['pulsar-core']:UtilsRound(GetEntityHeading(GLOBAL_VEH), 0)
					if RADAR_SETTINGS.frontRadar.transmit then
						...
						if hittingVehicle then
							local targetHeading = exports['pulsar-core']:UtilsRound(GetEntityHeading(hittingVehicle), 0)
							...
							local class = exports['pulsar-vehicles']:ClassGet(hittingVehicle)
...
function CheckPlateFlagged(direction, vehicle, plate)
	...
	if plateFlagged and not RECENT_FLAGS[plate] then
		...
		PlayFlaggedAlert()
		exports['pulsar-mdt']:EmergencyAlertsCreateClientAlert("Radar", "Flagged Plate Detected", "police_alerts",
