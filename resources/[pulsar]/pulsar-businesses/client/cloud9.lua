AddEventHandler("Businesses:Client:Startup", function()
	exports['pulsar-polyzone']:CreatePoly("cloud9-drift-area", {
...
AddStateBagChangeHandler("cloud9_drift", nil, function(bagName, key, value, _unused, replicated)
	if exports['pulsar-polyzone']:IsCoordsInZone(GetEntityCoords(LocalPlayer.state.ped), "cloud9-drift-area") then
		if value then
			DoDriftStuff()
		else
			DeleteDriftStuff()
