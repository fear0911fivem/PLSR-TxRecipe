...
AddEventHandler("Businesses:Server:Startup", function()
	exports["pulsar-core"]:RegisterServerCallback("Businesses:VANGELICOGRAPESEED:OpenTable", function(source, data, cb)
		exports.ox_inventory:OpenSecondary(source, 221, data)
	end)

	exports["pulsar-core"]:RegisterServerCallback("Businesses:VANGELICOGRAPESEED:Sell", function(source, data, cb)
		...
		if exports['pulsar-jobs']:HasJob(source, _jobName, false, false, false, false, "JOB_SELL_GEMS") then
			...
			if its and #its > 0 then
				...
				exports['pulsar-hud']:Notification(source, "error", "You Don't Have Any Gems To Sell")
			end
		end
	end)
end)
