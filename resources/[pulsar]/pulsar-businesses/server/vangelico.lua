...
AddEventHandler("Businesses:Server:Startup", function()
	exports["pulsar-core"]:RegisterServerCallback("Businesses:VANGELICO:OpenTable", function(source, data, cb)
		exports.ox_inventory:OpenSecondary(source, 196, data)
	end)

	exports["pulsar-core"]:RegisterServerCallback("Businesses:VANGELICO:Sell", function(source, data, cb)
