exports('WarrantsSearch', function(term, page, perPage)
...
exports('WarrantsView', function(id)
...
exports('WarrantsCreate', function(report, suspect, notes, author)
...
exports('WarrantsUpdate', function(id, state)
...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
	exports["pulsar-core"]:RegisterServerCallback("MDT:Search:warrant", function(source, data, cb)
		cb(exports['pulsar-mdt']:WarrantsSearch(data.term, data.page, data.perPage))
	end)

	exports["pulsar-core"]:RegisterServerCallback("MDT:View:warrant", function(source, data, cb)
		cb(exports['pulsar-mdt']:WarrantsView(data))
	end)

	exports["pulsar-core"]:RegisterServerCallback("MDT:Update:warrant", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)

		if char and CheckMDTPermissions(source, false) then
			cb(exports['pulsar-mdt']:WarrantsUpdate(data.id, data.state))
		else
			cb(false)
		end
	end)
