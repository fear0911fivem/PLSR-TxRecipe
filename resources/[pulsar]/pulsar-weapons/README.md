...
# PULSAR-WEAPONS
**Weapon configuration and melee combat system for Pulsar Framework**
...
Weapon management system for Pulsar Framework with configurable damage modifiers, attachment handling, and a dedicated melee combat configuration via `meleeconfig.lua`.
