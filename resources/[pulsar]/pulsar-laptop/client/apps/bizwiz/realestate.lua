...
RegisterNUICallback("Dyn8SearchProperties", function(d, cb)
    ...
    cb({
        properties = data,
        upgrades = exports['pulsar-properties']:GetUpgradesConfig(),
    })
end)
...
RegisterNUICallback("Dyn8StartSale", function(data, cb)
    exports["pulsar-core"]:ServerCallback("Properties:Dyn8:Sell", {
...
RegisterNUICallback("Dyn8StartTransfer", function(data, cb)
    exports["pulsar-core"]:ServerCallback("Properties:Dyn8:Transfer", {
        property = data.property,
        target = data.SID,
    }, cb)
end)
...
RegisterNUICallback("Dyn8ChangePropertyLocations", function(data, cb)
    exports["pulsar-core"]:ServerCallback("Properties:EditProperty", data, function(success)
...
RegisterNUICallback("Dyn8ShowPropertyLocations", function(data, cb)
    local prop = exports['pulsar-properties']:Get(data.property)
...
RegisterNUICallback("Dyn8CopyID", function(data, cb)
    exports['pulsar-admin']:CopyClipboard(data)
