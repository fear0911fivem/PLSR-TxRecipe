...
### Vehicle fuel consumption and refueling
...
Vehicle fuel system for Pulsar Framework. Tracks fuel consumption per vehicle class, gas station refueling with payment, jerry can item support, and HUD fuel gauge integration.
...
- `ox_inventory` — jerry can item handling
