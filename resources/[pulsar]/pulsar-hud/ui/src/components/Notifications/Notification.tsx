...
import { NOTIF_COLOR, NOTIF_TICK_MS, COLOR_NOTIF_BG, NOTIF_BORDER_WIDTH } from '../../hudTheme'
          ...
          <Box style={{ display: 'flex' }}>
            <Box
              style={{
                ...
                borderLeft: `${rem(NOTIF_BORDER_WIDTH)} solid ${accentColor}`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              }}
            >
              <FontAwesomeIcon icon={iconProp} style={{ color: accentColor, fontSize: rem(19) }} />
            </Box>

            <Box style={{ flex: 1, padding: `${rem(11)} ${rem(14)}`, minWidth: 0 }}>
              <Text style={{ fontSize: rem(15), fontWeight: 500, lineHeight: 1.4, wordBreak: 'break-word' }}>
              ...
              <Box style={{ display: 'flex', alignItems: 'center', gap: rem(6), marginTop: rem(2) }}>
                ...
                <Text style={{ fontSize: rem(12), color: 'rgba(255,255,255,0.3)', letterSpacing: '0.04em' }}>
