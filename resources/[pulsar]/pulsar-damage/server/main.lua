...
AddEventHandler('onResourceStart', function(resource)
  if resource == GetCurrentResourceName() then
    ...
    exports['pulsar-core']:VersionCheck('PulsarFW/pulsar-damage')
    ...
    exports["pulsar-core"]:RegisterServerCallback("Damage:GetLimbDamage", function(source, data, cb)
      ...
      if char ~= nil then
        local damage = exports['pulsar-damage']:GetLimbDamage(char:GetData("SID"))
    ...
    exports["pulsar-core"]:RegisterServerCallback("Damage:SyncReductions", function(source, data, cb)
      local char = exports['pulsar-characters']:FetchCharacterSource(source)
      if char ~= nil then
...
exports("EffectsPainkiller", function(source, tier)
  exports["pulsar-core"]:ClientCallback(source, "Damage:ApplyPainkiller", 225 * (tier or 1))
end)

exports("EffectsAdrenaline", function(source, tier)
  exports["pulsar-core"]:ClientCallback(source, "Damage:ApplyAdrenaline", 75 * (tier or 1))
end)
...
RegisterNetEvent("Damage:Server:Revived", function(wasMinor, wasFieldTreatment)
  ...
  if char ~= nil then
    ...
    if not wasMinor and not wasFieldTreatment then
      ...
      exports['pulsar-damage']:ResetLimbDamage(char:GetData("SID"))
    else
      if wasMinor then
        exports['pulsar-core']:LoggerTrace(
          "Damage",
