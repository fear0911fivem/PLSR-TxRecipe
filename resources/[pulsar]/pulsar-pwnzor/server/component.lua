...
AddEventHandler('onResourceStart', function(resource)
  if resource == GetCurrentResourceName() then
    Wait(1000)
    exports['pulsar-core']:VersionCheck('PulsarFW/pulsar-pwnzor')
    RegisterCallbacks()
    ...
    CreateThread(function()
      for k, v in ipairs(GetPlayers()) do
        ...
        if mult > 1.0 then
          local player = exports['pulsar-core']:FetchSource(tonumber(v))
...
AddEventHandler("playerDropped", function()
  exports['pulsar-pwnzor']:Disconnected(source)
end)
    ...
    if ev.explosionType == v then
      ...
      then
        ...
        if char then
          ...
          exports['pulsar-pwnzor']:Screenshot(char:GetData("SID"), "Potential Weapon Exploit")
        else
          exports['pulsar-core']:LoggerWarn("Pwnzor",
