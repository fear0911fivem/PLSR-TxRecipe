...
# PULSAR-TOW
**Tow truck job for vehicle impounding and recovery for Pulsar Framework**
...
Tow truck job system allowing players to impound, recover, and deliver vehicles. Supports job-locked access with configurable impound locations and payout rates.
