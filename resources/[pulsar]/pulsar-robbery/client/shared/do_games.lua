...
function DoLockpick(data, base, cb)
	...
	exports['pulsar-games']:MinigamePlayRoundSkillbar(base + (0.2 * stageComplete), size, {
		onSuccess = function()
			Wait(400)
...
function DoTracking(config, data, cb)
	exports['pulsar-games']:MinigamePlayTracking(config.countdown or 3, config.delay or 2500, config.limit or 20000,
...
function DoDrill(data, cb)
	exports['pulsar-games']:MinigamePlayDrill({
		onSuccess = function(data)
			cb(true, data)
		end,
		onFail = function(data)
