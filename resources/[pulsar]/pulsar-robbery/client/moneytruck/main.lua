...
AddEventHandler("Robbery:Client:Setup", function()
	exports["pulsar-core"]:RegisterClientCallback("Robbery:Moneytruck:CheckForTruck", function(data, cb)
	...
	exports["pulsar-core"]:RegisterClientCallback("Robbery:Moneytruck:Thermite:Door", function(data, cb)
	...
	exports["pulsar-core"]:RegisterClientCallback("Robbery:Moneytruck:Spawn:Get", function(data, cb)
	...
	exports["pulsar-core"]:RegisterClientCallback("Robbery:MoneyTruck:MarkTruck", function(data, cb)
...
AddEventHandler("Robbery:Client:MoneyTruck:GrabLoot", function(entity, data)
	exports["pulsar-core"]:ServerCallback("Robbery:MoneyTruck:CheckLoot", VehToNet(entity.entity), function(s)
		if s then
			exports['pulsar-hud']:Progress({
				...
				if not status then
					exports["pulsar-core"]:ServerCallback("Robbery:MoneyTruck:Loot", VehToNet(entity.entity),
						function(s2) end)
				else
					exports["pulsar-core"]:ServerCallback("Robbery:MoneyTruck:CancelLoot", VehToNet(entity.entity),
						function(s2) end)
				end
			end)
		end
