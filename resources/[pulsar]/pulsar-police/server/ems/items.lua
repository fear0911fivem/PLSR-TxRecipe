function EMSItems()
	...
	-- 		end
	-- 	else
	-- 		exports['pulsar-hud']:Notification(source, "error", "You're Not Bleeding")
	-- 	end
	-- end)

	exports.ox_inventory:RegisterUse("morphine", "MedicalItems", function(source, item)
		exports['pulsar-damage']:EffectsPainkiller(source, 1)
	end)
	...
	exports.ox_inventory:RegisterUse("oxy", "MedicalItems", function(source, item)
		...
		exports['pulsar-damage']:EffectsPainkiller(source, 2)
	...
	exports.ox_inventory:RegisterUse("bandage", "MedicalItems", function(source, item)
		...
		do
			...
			if curr < (max * 0.75) then
				local p = promise.new()
				exports["pulsar-core"]:ClientCallback(source, "EMS:Heal", heal, function(s)
					p:resolve(s)
				end)
				Citizen.Await(p)
			end
	...
	-- 		else
	-- 			exports['pulsar-hud']:Notification(source, "error", "You continue bleeding through the gauze")
	-- 		end
	-- 	end
	-- end)
	...
	exports.ox_inventory:RegisterUse("medicalkit", "MedicalItems", function(source, item)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if exports['pulsar-jobs']:HasJob(source, "ems", false, false, 2) then
			...
			exports['pulsar-hud']:Notification(source, "error", "Not Near Any Hospitalized Patients")
		else
			exports['pulsar-hud']:Notification(source, "error", "You're not trained to use this")
		end
	end)
end
