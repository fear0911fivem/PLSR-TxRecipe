...
function RegisterChatCommands()
	exports["pulsar-chat"]:RegisterAdminCommand("wardrobe", function(source, args, rawCommand)
		TriggerClientEvent("Wardrobe:Client:ShowBitch", source)
	end, {
		help = "Test Notification",
	})
	exports["pulsar-chat"]:RegisterAdminCommand("ped", function(source, args, rawCommand)
		local char
		local shopType = 0
		...
		if args[2] and tonumber(args[2]) >= 1 then
			char = exports['pulsar-characters']:FetchBySID(args[2])
		else
		...
		if char ~= nil then
			...
			exports['pulsar-hud']:Notification(source, "error", "Player is not online.", 2000)
		end
	end, {
...
function RegisterWardrobeCallbacks()
	exports["pulsar-core"]:RegisterServerCallback("Wardrobe:GetAll", function(source, data, cb)
	...
	exports["pulsar-core"]:RegisterServerCallback("Wardrobe:Save", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
	...
	exports["pulsar-core"]:RegisterServerCallback("Wardrobe:SaveExisting", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
	...
	exports["pulsar-core"]:RegisterServerCallback("Wardrobe:Equip", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local outfit = char:GetData("Wardrobe")[tonumber(data)]
			if outfit ~= nil then
				exports['pulsar-ped']:ApplyOutfit(source, outfit)
				cb(true)
			else
				cb(false)
			end
	...
	exports["pulsar-core"]:RegisterServerCallback("Wardrobe:Delete", function(source, data, cb)
		local char = exports['pulsar-characters']:FetchCharacterSource(source)
		if char ~= nil then
			local wardrobe = char:GetData("Wardrobe") or {}
