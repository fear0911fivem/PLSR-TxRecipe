...
# PULSAR-WEED
**Weed cultivation and drug operation system for Pulsar Framework**
...
Weed growing operation for Pulsar Framework with custom streamed prop models, grow stages, and configurable yield and processing chains.
