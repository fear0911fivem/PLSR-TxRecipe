...
function OpenVehicleCustoms(canInstallPerformance, costMultiplier, settings)
	...
	local originalData = exports['pulsar-vehicles']:PropertiesGet(CUST_VEH)
	local changingData = {
		mods = {},
	}

	customsMenu = exports['pulsar-menu']:Create("vehicle_customs", "Vehicle Customs", function()
		CUSTOMS_OPEN = true
	end, function()
		Wait(100)
		customsMenu = false
		...
		exports["pulsar-hud"]:Notification("remove", nil, nil, nil, nil, "veh_customs")

		if not isSaving then
			exports['pulsar-core']:LoggerTrace("VehicleCustoms", "Not Saving - Reset Mods")
			exports['pulsar-vehicles']:PropertiesSet(CUST_VEH, originalData)
			exports["pulsar-hud"]:Notification("error", "Changes Discarded - You Weren't Charged")
		end
		CUSTOMS_OPEN = false
	end, true)
	...
	exports["pulsar-hud"]:Notification("standard", "Current Total: $" .. 0, -1, "veh_customs", nil, "veh_customs")

	local function updateVehiclePropertyState()
		exports['pulsar-vehicles']:PropertiesSet(CUST_VEH, originalData)
		exports['pulsar-vehicles']:PropertiesSet(CUST_VEH, changingData)

		local newCost = CalculateCustomsCost(changingData, costMultiplier)
		exports["pulsar-hud"]:Notification("standard", "Current Total: $" .. newCost, -1, "veh_customs", nil,
			"veh_customs")
	...
	customsMenuSubs["paint"] = exports['pulsar-menu']:Create("vehicle_customs_paint", "Paint")
	...
	customsMenuSubs["livery"] = exports['pulsar-menu']:Create("vehicle_customs_livery", "Liveries")
	...
	-- EXTRAS
	customsMenuSubs["extras"] = exports['pulsar-menu']:Create("vehicle_customs_extras", "Extras")
	...
	-- Lighting
	customsMenuSubs["lighting"] = exports['pulsar-menu']:Create("vehicle_customs_lighting", "Lighting")
	...
	customsMenuSubs["wheels"] = exports['pulsar-menu']:Create("vehicle_customs_wheels", "Wheels")
	...
	customsMenuSubs["body_parts"] = exports['pulsar-menu']:Create("vehicle_customs_body_parts", "Body Parts")
	...
	if canInstallPerformance then
		customsMenuSubs["performance"] = exports['pulsar-menu']:Create("vehicle_customs_performance", "Performance")
	...
	customsMenu.Add:Button("Pay and Save Changes", { success = true }, function()
		...
		if LocalPlayer.state.Character:GetData("Cash") >= currentCost then
			isSaving = true
			exports['pulsar-core']:LoggerTrace("VehicleCustoms", "Attempt Mods Save")
			customsMenu:Close()

			exports["pulsar-core"]:ServerCallback("Vehicles:CompleteCustoms", {
				vNet = VehToNet(CUST_VEH),
				changes = changingData,
				cost = currentCost,
				new = exports['pulsar-vehicles']:PropertiesGet(CUST_VEH),
			}, function(success, newNewData)
				if success then
					exports['pulsar-sounds']:UISoundsPlayFrontEnd(-1, "PURCHASE", "HUD_LIQUOR_STORE_SOUNDSET")
					exports["pulsar-hud"]:Notification("success", "New Modifications Saved & Paid For")
					if newNewData then
						exports['pulsar-vehicles']:PropertiesSet(CUST_VEH, newNewData)
					end
				else
					exports["pulsar-hud"]:Notification("error", "Error Saving Vehicle Modifications - Not Enough Money?")
					exports['pulsar-vehicles']:PropertiesSet(CUST_VEH, originalData)
				end
			end)
		else
